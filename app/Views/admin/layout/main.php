...
<body class="file-detail-show">
    ...
    <div id="layout-wrapper">
        ...
        <?php include APPPATH . 'Views/admin/layout/top-bar.php'; ?>
        <?php include APPPATH . 'Views/admin/layout/sidebar.php'; ?>
        <!-- Left Sidebar End -->
        <!-- Vertical Overlay-->
        ...
        <div class="main-content">
            ...
            <?= $content_view ? view($content_view, $content_data) : $this->renderSection('content') ?>

            <?php include APPPATH . 'Views/admin/layout/footer.php'; ?>
        </div>
        <!-- end main content-->
