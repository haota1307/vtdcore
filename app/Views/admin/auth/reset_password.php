...
<head>
    ...
    <title><?= $title ?? 'Reset Password' ?> - VTDevCore</title>
    ...
    <div class="login-container">
        <div class="login-header">
            <div class="login-brand">
                <i data-feather="key"></i> VTDevCore
            </div>
        ...
        <div class="login-body">
            ...
            <form action="<?= admin_url('auth/process-reset-password') ?>" method="post">
                <?= csrf_field() ?>
